...
namespace grafikaLab8
{
    ...
    class Filtry
    {
            ...
            for (int x = 1; x < bitmap.Width - 1; x++)
            {
                for (int y = 1; y < bitmap.Height - 1; y++)
                {
                    for (int i = -1; i < 2; i++)
                    {
                        for (int j = -1; j < 2; j++)
                        {
                            colors[i + 1, j + 1] = bitmap.GetPixel(x + i, y + j);
                        }
                    }
                    int r = 0, g = 0, b = 0;
                    for (int i = -1; i < 2; i++)
        ...
        public Bitmap max(Bitmap bitmap1, Bitmap bitmap2)
        {
            Bitmap b1 = bitmap1;
            Bitmap b2 = bitmap2;
        ...
        public Bitmap min(Bitmap bitmap1, Bitmap bitmap2)
        {
            Bitmap b1 = bitmap1;
            Bitmap b2 = bitmap2;
            Color[,] k = new Color[3, 3];
        ...
        public Bitmap mediana(Bitmap bitmap1, Bitmap bitmap2)
        {
            Bitmap b1 = bitmap1;
            Bitmap b2 = bitmap2;
            Color[,] k = new Color[3, 3];
